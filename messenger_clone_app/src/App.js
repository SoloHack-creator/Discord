...
import './App.css';
import { FormControl, Icon, Input } from '@material-ui/core';
...
db.collection('messages').orderBy('timestamp','desc').onSnapshot(snapshot=>{
  ...
  return (
   ...
   <img src='https://facebookbrand.com/wp-content/uploads/2018/09/Header-e1538151782912.png?w=50&h=50'></img>
  ...
  <form className="app__form">
     <FormControl className="app__formcontrol">
       ...
       <Input  className="app__input" value={input} onChange={(event)=>{setInput(event.target.value)}}></Input>
